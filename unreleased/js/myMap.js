// global geoserver internal test url
var geoserverUrl = "http://giswmsdv01:8080/geoserver/lbi_gs/ows?service=WFS&version=1.0.0&request=GetFeature";
var geoserverCamdenUrl = "http://gis.camden.gov.uk/geoserver/ows?SERVICE=WFS&VERSION=1.0.0&REQUEST=GetFeature";
...
// LISTENERS   
// Small device open navbar - toggle chevron on click
...
function enableBaselayers(){
    ...
    window.baselayers = {
        ...
        1: {name: "OSM Mapnik", layer: OpenStreetMap_Mapnik},
        2: {name: "Stamen Watercolor", layer: Stamen_Watercolor},
        3: {name: "Stamen Toner", layer: Stamen_Toner}
    }
